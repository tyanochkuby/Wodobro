...
class HomePageViewModel {
  Future<List<int>> homePageViewModel() async {
    final int additionalWater =
        await HydrationController.estimateTodayHydration();
    final int todayHydration =
        await locator.get<DiaryDomainController>().getTodayHydration();
